...
The main characteristic of a XSS attack is that it executes scripts that run on the client side. This is usually javascript, and even if XSS per se isn't restricted to it, in practice the exceptions are extremly rare.
